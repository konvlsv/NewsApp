    ...
    when {
        state.isError && state.article == null -> {
            ErrorScreen(
                ...
                onRefresh = { viewModel.handleEvent(DetailsEvent.OnRefresh) },
                modifier = modifier
            )
        }
...
fun DetailsContent(
    ...
    Column(
        ...
        Row(
            ...
            IconButton(onClick = dropUnlessResumed { onEvent(DetailsEvent.OnOpenInBrowser(article)) }) {
                Icon(
            ...
            IconButton(onClick = dropUnlessResumed { onEvent(DetailsEvent.OnShare(article)) }) {
                Icon(
